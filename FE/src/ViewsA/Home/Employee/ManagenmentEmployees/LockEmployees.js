...
const Lockemployees = () => {
  ...
  const fetchEmployees = async () => {
    try {
      ...
      const response = await fetch(`${BASE_URL}/employees?admin_id=${admin_id}`);
      if (!response.ok) {
  ...
  const handleActivate = async () => {
    try {
      ...
      const response = await fetch(`${BASE_URL}/employeesactive`, {
        method: 'PUT',
        headers: {
  ...
  const handleUnactivate = async () => {
    try {
      ...
      const response = await fetch(`${BASE_URL}/employeesunactive`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
